...
if (new Date - user.lastweekly < 259200000) return await conn.reply(m.chat, `لقد تلقيت بالفعل مكافأتك الأسبوعية ⛅`, fkontak,  m)
...
┃ ${texto}
╰━━💫━☃️━🌛━━⬣\n\n🎟️ ب ر ي م ي و م ⇢ ${premium ? '✅' : '❌'}\n${wm}`
await conn.sendFile(m.chat, img, 'gata.jpg', text, fkontak) 
user.lastweekly = new Date * 1
}
handler.command = ['weekly', 'اسبوعي', 'اسبوع', 'cadasemana', 'entregasemanal'] 
handler.level = 7
