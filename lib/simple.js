	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363297635509525@newsletter',
            newsletterName: '𝙎𝙖𝙛𝙧𝙤𝙩-𝙈𝘿', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363297635509525@newsletter", "120363297635509525@newsletter", "120363297635509525@newsletter", "120363297635509525@newsletter"]
let canalNombre = ["ₛₐfᵣₒₜ bₒₜ", "ₛₐfᵣₒₜ bₒₜ", "ₛₐfᵣₒₜ bₒₜ", "ₛₐfᵣₒₜ bₒₜ"]
